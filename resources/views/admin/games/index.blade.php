...
<div class="container max-w-7xl mx-auto mt-8">
  <div class="mb-4">
    ...
    <div class="flex justify-end">
      <a href="{{route('admin.games.create')}}" class="px-4 py-2 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600">Create Game</a>
    </div>
    @if (session('info'))
        ...
        <table class="min-w-full">
          ...
          <!-- Links
              ...
              <td class="text-sm font-medium leading-5 text-center whitespace-no-wrap border-b border-gray-200 ">
                <a href="{{ route ('admin.games.edit', $game) }}" class="text-indigo-600 hover:text-indigo-900">
